...
export const DEDUCTION_CATALOG: DeductionItem[] = [
  ...
  { key: "letting-management", title: "Letting & management fees", blurb: "Agent fees for finding tenants and managing the let.", categoryName: "Legal, management, other professional fees", match: { descriptionKeywords: ["letting", "management", "letting agent", "managing agent"] }, action: "transaction" },
  ...
  { key: "replacement-domestic", title: "Replacement of domestic items", blurb: "Replacing furniture, white goods, carpets or curtains in a furnished let (like-for-like).", categoryName: "Other allowable property expenses", match: { descriptionKeywords: ["replace", "furniture", "white good", "carpet", "curtain", "appliance", "fridge", "washing machine", "sofa"] }, action: "transaction" },
  { key: "safety-servicing", title: "Safety & servicing", blurb: "Boiler service, smoke/CO alarms, PAT testing, Legionella assessment, chimney sweep.", categoryName: "Property repairs and maintenance", match: { descriptionKeywords: ["boiler service", "smoke alarm", "carbon monoxide", "co alarm", "fire alarm", "pat test", "legionella", "chimney"] }, action: "transaction" },
