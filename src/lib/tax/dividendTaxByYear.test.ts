...
describe("dividendTaxForYears", () => {
  it("applies dividendTax per tax year, preserving order", () => {
    ...
    expect(rows).toEqual([
      { taxYear: "2025-26", dividendPence: 10_000_00, taxPence: 831_25 },   // ordinary band, 2025-26 rates
      // 2024-25 is unconfigured → falls back to the latest year (2026-27): straddles basic→higher
      // 4,770 @ 10.75% + 4,730 @ 35.75% = 2,203.75
      { taxYear: "2024-25", dividendPence: 10_000_00, taxPence: 2_203_75 },
    ]);
  });
